const Footer = () => {
  return (
    <>
      ...
      <footer className="bg-[var(--Primary-2)]">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a
                href="#"
                className="text-white hover:text-gray-400 dark:hover:text-grey-400"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
              ...
              <a
                href="#"
                className="text-white hover:text-gray-400 dark:hover:text-grey-400 ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
