    ...
    <section className="bg-[var(--Primary-2)] min-h-screen w-full relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-between px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-20">
        <div className="flex-1 max-w-2xl">
          ...
          <button className="bg-[var(--Secondary-1)] text-[var(--Primary-1)] py-3 sm:py-4 px-6 sm:px-8 rounded-full font-semibold hover:bg-opacity-90 transition-all duration-300 hover:shadow-lg hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[var(--Primary-1)] focus:ring-opacity-50">
            EXPLORE COURSES
          </button>
        </div>
