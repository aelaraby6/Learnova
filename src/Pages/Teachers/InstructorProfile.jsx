  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        {/* Blue header section */}
        <div className="bg-blue-600 py-16 sm:py-20 my-20">
                  ...
                  <div className="flex-1 text-center lg:text-left">
                    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4">
                      <div>
                        ...
                        {/* Expertises */}
                        {instructor.expertises &&
                          instructor.expertises.length > 0 && (
                            <div className="mb-4">
                              <h3 className="text-sm font-semibold text-gray-700 mb-2">
                                Expertises:
                              </h3>
                              <div className="flex flex-wrap gap-2">
                                {instructor.expertises.map(
                                  (expertise, index) => (
                                    <span
                                      key={index}
            ...
            <div className="flex flex-col items-center justify-center max-w-4xl mx-auto">
              ...
              <div className="w-full mb-12 lg:mb-16">
                ...
                <p className="text-gray-600 text-base lg:text-lg leading-relaxed text-center max-w-3xl mx-auto">
                  {instructor.bio ||
                    "Professional instructor with expertise in modern technologies."}
                </p>
              </div>
